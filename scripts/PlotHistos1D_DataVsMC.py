...
sOpDir = f'/afs/cern.ch/work/c/csutanta/HTOAA_CMSSW/BBQQ_calibration/plots/v2_2017/{sOpDir_substr[1]}'
...
for sData, ExpData_list in ExpData_dict.items():
    ...
    luminosity_Scaling_toUse = 1 #round(luminosity_toUse, 2) / round(luminosity_total, 2)
    luminosity_toUse = Luminosities_forGGFMode[era][HLT_toUse][0]# round(luminosity_toUse, 2)
