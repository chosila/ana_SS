...
histograms_dict = OD([
    ...
    # ("FatJet_deepTagMD_ZHbbvsQCD"       , {sXLabel: 'FatJet_deepTagMD_ZHbbvsQCD'      , sYLabel : 'Events', sYRange : [0,1], sNRebinX: 2}),
    # ("FatJet_particleNetMD_Xbb"         , {sXLabel: 'FatJet_particleNetMD_Xbb'        , sYLabel : 'Events', sYRange : [0,1], sNRebinX: 2}),
    # ("FatJet_particleNetMD_Hto4b_Haa4b" , {sXLabel: 'FatJet_particleNetMD_Hto4b_Haa4b', sYLabel : 'Events', sYRange : [0,1], sNRebinX: 2}),
    # ("FatJet_particleNetMD_Hto4b_Haa3b" , {sXLabel: 'FatJet_particleNetMD_Hto4b_Haa3b', sYLabel : 'Events', sYRange : [0,1], sNRebinX: 2}),
    # ("FatJet_particleNetMD_Hto4b_Haa2b" , {sXLabel: 'FatJet_particleNetMD_Hto4b_Haa2b', sYLabel : 'Events', sYRange : [0,1], sNRebinX: 2}),
