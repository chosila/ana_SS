...
ExpData_dict = {
    'Data ABCD' : ['SingleElectron_Run2017B', 'SingleElectron_Run2017C', 'SingleElectron_Run2017D', 'SingleElectron_Run2017E', 'SingleElectron_Run2017F'],
    #'Data ABCD' : ['SingleMuon_Run2017B', 'SingleMuon_Run2017C', 'SingleMuon_Run2017D', 'SingleMuon_Run2017E', 'SingleMuon_Run2017F'],
...
HLT_toUse = 'Trg_Combo_Mu' #'HLT_IsoMu24'
...
histograms_dict = OD([
    ...
    ("hLeadingElectronPt", {sXLabel: 'hLeadingElectronPt', sYLabel: 'Events', sXRange: [1, 500], sNRebinX: 8 }),
    ...
    ("particleNetMD_XbbOverQCD", {sXLabel: 'particleNetMD_XbbOverQCD', sYLabel: 'Events', sXRange: [0, 1], sNRebinX: 8 }),
    ...
    ('flavB_near_lJ', {sXLabel: 'flavB_near_lJ', sYLabel: 'Events', sXRange: [0,1], sNRebinX: 16}), # mlscore axis
    ...
    ('flavB_near_lep', {sXLabel: 'flavB_near_lep', sYLabel: 'Events', sXRange: [0,1], sNRebinX: 16}),
    ('jet_pt_near_lep', {sXLabel: 'jet_pt_near_lep', sYLabel: 'Events', sXRange: [1,1200], sNRebinX: 20}),
    ('mass_lJ', {sXLabel: 'mass_lJ', sYLabel: 'Events', sXRange: [170, 1200], sNRebinX: 16}),
    ...
    ('bbqq4_xgb_score', {sXLabel: 'bbqq4_xgb_score', sYLabel: 'Events', sXRange: [0,1], sNRebinX:16}),
    ('bbqq11_xgb_score', {sXLabel: 'bbqq11_xgb_score', sYLabel: 'Events', sXRange: [0,1], sNRebinX:16}),
    ('bbqq_bbq13_xgb_score', {sXLabel: 'bbqq_bbq13_xgb_score', sYLabel: 'Events', sXRange: [0,1], sNRebinX:16}),
    ...
    ('btagHbb', {sXLabel: 'btagHbb', sYLabel: 'Events', sXRange: [-1,1], sNRebinX:16}),
    ('particleNetMD_Xbb', {sXLabel: 'particleNetMD_Xbb', sYLabel: 'Events', sXRange: [0,1], sNRebinX:4}),
    ('btagDDBvLV2', {sXLabel: 'btagDDBvLV2', sYLabel: 'Events', sXRange: [0,1], sNRebinX:8}),
    ('deepTagMD_ZHbbvsQCD', {sXLabel: 'deepTagMD_ZHbbvsQCD', sYLabel: 'Events', sXRange: [0,1], sNRebinX:16}),
    ...
    ## v2 plots
    ('PNet_X4b_v1_Haa34b_score', {sXLabel: 'PNet_X4b_v1_Haa34b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_X4b_v1_Haa4b_score', {sXLabel: 'PNet_X4b_v1_Haa4b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_X4b_v2a_Haa34b_score', {sXLabel: 'PNet_X4b_v2a_Haa34b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_X4b_v2a_Haa4b_score', {sXLabel: 'PNet_X4b_v2a_Haa4b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_X4b_v2b_Haa34b_score', {sXLabel: 'PNet_X4b_v2b_Haa34b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_X4b_v2b_Haa4b_score', {sXLabel: 'PNet_X4b_v2b_Haa4b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_X4b_v2_Haa34b_score', {sXLabel: 'PNet_X4b_v2_Haa34b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_X4b_v2_Haa4b_score', {sXLabel: 'PNet_X4b_v2_Haa4b_score', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T2b_vs_01b', {sXLabel: 'PNet_TT_T2b_vs_01b', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_bbqq_vs_01b', {sXLabel: 'PNet_TT_bbqq_vs_01b', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_QCD', {sXLabel: 'PNet_TT_QCD', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_X', {sXLabel: 'PNet_TT_X', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T1b', {sXLabel: 'PNet_TT_T1b', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T2b', {sXLabel: 'PNet_TT_T2b', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_bbqq', {sXLabel: 'PNet_TT_bbqq', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T1b2q', {sXLabel: 'PNet_TT_T1b2q', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T1bb2q', {sXLabel: 'PNet_TT_T1bb2q', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T1bbb2q', {sXLabel: 'PNet_TT_T1bbb2q', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T2b1q', {sXLabel: 'PNet_TT_T2b1q', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_T2b2q', {sXLabel: 'PNet_TT_T2b2q', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
    ('PNet_TT_TTHad', {sXLabel: 'PNet_TT_TTHad', sYLabel:'Events', sXRange: [0,1], sNRebinX: 20}),
