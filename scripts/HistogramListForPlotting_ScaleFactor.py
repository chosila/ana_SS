...
histograms_dict = OD([
    ...
    ('xgb_score', {sXLabel: 'xgb_score', sYLabel: 'Events', sXRange: [0,1], sNRebinX:1}),
    ...
    # ('btagDDBvLV2', {sXLabel: 'btagDDBvLV2', sYLabel: 'Events', sXRange: [0,1], sNRebinX:1}),

    ('deepTagMD_ZHbbvsQCD', {sXLabel: 'deepTagMD_ZHbbvsQCD', sYLabel: 'Events', sXRange: [0,1], sNRebinX:1}),
    # ('particleNetMD_XbbOverQCD', {sXLabel: 'particleNetMD_XbbOverQCD', sYLabel: 'Events', sXRange:[0,1], sNRebinX:1}),
    ("hLeadingFatJetParticleNetMD_XbbOverQCD", {sXLabel: 'hLeadingFatJetParticleNetMD_XbbOverQCD', sYLabel: 'Events', sXRange: [0, 1], sNRebinX: 1}),
    # ('Htoaa3b_Htoaa4bOverQCD', {sXLabel: 'Htoaa3b_Htoaa4bOverQCD', sYLabel: 'Events', sXRange:[0,1], sNRebinX:1}),
    #('GenPartpdgID', {sXLabel: 'GenPartpdgID', sYLabel: 'Events', sXRange:[-0.5, 100.5], sNRebinX:1}),
])
